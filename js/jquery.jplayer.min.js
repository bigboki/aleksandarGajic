...
this.element.append(b)}else{f='<embed name="'+this.internal.flash.id+'" id="'+this.internal.flash.id+'" src="'+this.internal.flash.swf+'"';f+=' width="0" height="0" bgcolor="'+this.options.backgroundColor+'"';f+=' quality="high" FlashVars="'+b+'"';f+=' allowScriptAccess="always"';f+=' type="application/x-shockwave-flash" pluginspage="https://web.archive.org/web/20211207134954/http://www.macromedia.com/go/getflashplayer" />';this.element.append(f)}this.internal.flash.jq=c("#"+this.internal.flash.id);this.internal.flash.jq.css({width:"0px",
...
/*
     FILE ARCHIVED ON 13:49:54 Dec 07, 2021 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 19:50:30 Sep 29, 2025.
...
playback timings (ms):
  ...
  esindex: 0.009
  cdx.remote: 74.6
  LoadShardBlock: 485.544 (3)
  PetaboxLoader3.datanode: 1121.443 (4)
  load_resource: 728.792
